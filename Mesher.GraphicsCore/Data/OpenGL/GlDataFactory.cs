...
{
    public class GlDataFactory : IDataFactory, IDisposable 
    {
        ...
        public GlDataFactory(GlWindowsRenderContext defaultRenderWindow)
        {
        ...
        Texture.Texture IDataFactory.CreateTexture(Bitmap bitmap)
        {
